import{a as m,b as u,c as y,d as n,e,f as w,g as c,h as M,i as d,j as v,k as a,l as Z}from"./chunk-P5BKPNBI.js";import{e as f}from"./chunk-SVM3HCG7.js";var L,$,s,t,x=f(()=>{y();w();M();v();Z();u();L=Object.defineProperty,$=Object.getOwnPropertyDescriptor,s=(o,i,p,l)=>{for(var r=l>1?void 0:l?$(i,p):i,h=o.length-1,g;h>=0;h--)(g=o[h])&&(r=(l?g(i,p,r):g(r))||r);return l&&r&&L(i,p,r),r},t=class extends c{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var o;return n`<svg
  ...
  `;s([a({type:String,reflect:!0})],t.prototype,"size",2);s([a({type:String,reflect:!0})],t.prototype,"weight",2);s([a({type:String,reflect:!0})],t.prototype,"color",2);s([a({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=s([d("ph-caret-left")],t)});x();export{t as PhCaretLeft};
