import{a as l,b as d,c as Z,d as m,e as a,f as y,g as n,h as f,i as g,j as M,k as o,l as u}from"./chunk-P5BKPNBI.js";import{e as c}from"./chunk-SVM3HCG7.js";var w,v,H,t,A=c(()=>{Z();y();f();M();u();d();w=Object.defineProperty,v=Object.getOwnPropertyDescriptor,H=(r,V,s,i)=>{for(var e=i>1?void 0:i?v(V,s):V,p=r.length-1,h;p>=0;p--)(h=r[p])&&(e=(i?h(V,s,e):h(e))||e);return i&&e&&w(V,s,e),e},t=class extends n{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var r;return m`<svg
  ...
  `;H([o({type:String,reflect:!0})],t.prototype,"size",2);H([o({type:String,reflect:!0})],t.prototype,"weight",2);H([o({type:String,reflect:!0})],t.prototype,"color",2);H([o({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=H([g("ph-copy")],t)});A();export{t as PhCopy};
