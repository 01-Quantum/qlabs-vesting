import{a as m,b as w,c as u,d as n,e as r,f as y,g as c,h as v,i as d,j as M,k as l,l as H}from"./chunk-P5BKPNBI.js";import{e as f}from"./chunk-SVM3HCG7.js";var A,Z,o,t,L=f(()=>{u();y();v();M();H();w();A=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,o=(a,i,p,s)=>{for(var e=s>1?void 0:s?Z(i,p):i,h=a.length-1,g;h>=0;h--)(g=a[h])&&(e=(s?g(i,p,e):g(e))||e);return s&&e&&A(i,p,e),e},t=class extends c{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return n`<svg
  ...
  `;o([l({type:String,reflect:!0})],t.prototype,"size",2);o([l({type:String,reflect:!0})],t.prototype,"weight",2);o([l({type:String,reflect:!0})],t.prototype,"color",2);o([l({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([d("ph-arrow-left")],t)});L();export{t as PhArrowLeft};
