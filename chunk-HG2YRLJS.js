import{a as m,b as u,c as H,d as n,e as r,f as V,g as v,h as f,i as c,j as y,k as o,l as w}from"./chunk-P5BKPNBI.js";import{e as d}from"./chunk-SVM3HCG7.js";var M,A,s,t,Z=d(()=>{H();V();f();y();w();u();M=Object.defineProperty,A=Object.getOwnPropertyDescriptor,s=(a,h,p,i)=>{for(var e=i>1?void 0:i?A(h,p):h,l=a.length-1,g;l>=0;l--)(g=a[l])&&(e=(i?g(h,p,e):g(e))||e);return i&&e&&M(h,p,e),e},t=class extends v{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return n`<svg
  ...
  `;s([o({type:String,reflect:!0})],t.prototype,"size",2);s([o({type:String,reflect:!0})],t.prototype,"weight",2);s([o({type:String,reflect:!0})],t.prototype,"color",2);s([o({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=s([c("ph-plus")],t)});Z();export{t as PhPlus};
