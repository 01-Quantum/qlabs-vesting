import{a as g,b as A,c as f,d as m,e as r,f as v,g as c,h as u,i as d,j as y,k as a,l as M}from"./chunk-P5BKPNBI.js";import{e as w}from"./chunk-SVM3HCG7.js";var H,L,l,t,Z=w(()=>{f();v();u();y();M();A();H=Object.defineProperty,L=Object.getOwnPropertyDescriptor,l=(o,s,h,i)=>{for(var e=i>1?void 0:i?L(s,h):s,p=o.length-1,n;p>=0;p--)(n=o[p])&&(e=(i?n(s,h,e):n(e))||e);return i&&e&&H(s,h,e),e},t=class extends c{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var o;return m`<svg
  ...
  `;l([a({type:String,reflect:!0})],t.prototype,"size",2);l([a({type:String,reflect:!0})],t.prototype,"weight",2);l([a({type:String,reflect:!0})],t.prototype,"color",2);l([a({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=l([d("ph-arrow-clockwise")],t)});Z();export{t as PhArrowClockwise};
