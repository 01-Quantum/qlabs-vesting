import{a as n,b as A,c as f,d as c,e as r,f as v,g,h as u,i as Z,j as y,k as o,l as w}from"./chunk-P5BKPNBI.js";import{e as d}from"./chunk-SVM3HCG7.js";var M,H,s,t,V=d(()=>{f();v();u();y();w();A();M=Object.defineProperty,H=Object.getOwnPropertyDescriptor,s=(a,i,h,p)=>{for(var e=p>1?void 0:p?H(i,h):i,l=a.length-1,m;l>=0;l--)(m=a[l])&&(e=(p?m(i,h,e):m(e))||e);return p&&e&&M(i,h,e),e},t=class extends g{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return c`<svg
  ...
  `;s([o({type:String,reflect:!0})],t.prototype,"size",2);s([o({type:String,reflect:!0})],t.prototype,"weight",2);s([o({type:String,reflect:!0})],t.prototype,"color",2);s([o({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=s([Z("ph-clock")],t)});V();export{t as PhClock};
