import{a as m,b as f,c as u,d as n,e,f as y,g as c,h as v,i as d,j as M,k as i,l as H}from"./chunk-P5BKPNBI.js";import{e as w}from"./chunk-SVM3HCG7.js";var L,A,s,t,Z=w(()=>{u();y();v();M();H();f();L=Object.defineProperty,A=Object.getOwnPropertyDescriptor,s=(o,a,p,l)=>{for(var r=l>1?void 0:l?A(a,p):a,h=o.length-1,g;h>=0;h--)(g=o[h])&&(r=(l?g(a,p,r):g(r))||r);return l&&r&&L(a,p,r),r},t=class extends c{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var o;return n`<svg
  ...
  `;s([i({type:String,reflect:!0})],t.prototype,"size",2);s([i({type:String,reflect:!0})],t.prototype,"weight",2);s([i({type:String,reflect:!0})],t.prototype,"color",2);s([i({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=s([d("ph-arrow-right")],t)});Z();export{t as PhArrowRight};
